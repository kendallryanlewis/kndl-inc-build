    ...
    packages = [
        {
            ...
            deliverables: [
                ...
                },
                {
                    ...
                    description: 'One social profile setup with custom branding and initial post',
                    details: ['Profile creation & optimization', 'Custom branded graphics', '1 initial post created', 'Bio optimization', 'Contact info setup']
                },
                {
            ...
            process: [
                ...
                { step: 5, title: 'Launch', description: 'Final review and launch', duration: '1 day' }
            ],
            addOns: [
                { title: 'Additional Social Profile', price: '$75', description: 'Set up one additional social media profile with branding' },
                { title: 'Domain Registration', price: '$50', description: 'Register your custom domain name' },
                { title: 'Logo Touch-Up', price: '$150', description: 'Minor logo refresh or cleanup' },
                { title: 'Business Cards', price: '$100', description: 'Simple business card design with print-ready files' },
                { title: 'Basic Email Setup', price: '$125', description: 'Professional email address setup' }
            ],
            portfolio: [
        ...
        },
        {
            ...
            process: [
                ...
                { step: 5, title: 'Launch & Training', description: 'Complete launch with training on managing your expanded presence.', duration: '1 day' }
            ],
            addOns: [
                { title: 'E-commerce Setup', price: '$300', description: 'Basic online store with payment processing' },
                { title: 'Booking System', price: '$250', description: 'Online appointment booking integration' },
                { title: 'Email Marketing Setup', price: '$200', description: 'Email list and automation setup' },
                { title: 'Print Materials', price: '$150-300', description: 'Business cards, flyers, or brochures' },
                { title: 'Additional Pages', price: '$100/page', description: 'Extra website pages beyond the 5 included' }
            ],
            portfolio: [
        ...
        },
        {
            ...
            video: 'assets/Video/corporate.mp4',
            icon: 'fa fa-crown',
            color: '#f4d03f',
            text: '#000000',
            ...
            process: [
                ...
                { step: 3, title: 'Custom Development', description: 'Build your custom website with advanced features and integrations.', duration: '5-7 days' },
                ...
                { step: 5, title: 'Launch & Optimization', description: 'Full launch with performance optimization and team training.', duration: '1-2 days' }
            ],
            addOns: [
                { title: 'Advanced E-commerce', price: '$500+', description: 'Full online store with inventory management' },
                { title: 'Custom Portal/Dashboard', price: '$750+', description: 'Client or employee dashboard with custom features' },
                { title: 'API Integrations', price: '$300+', description: 'Connect with third-party services and tools' },
                { title: 'Monthly Marketing Management', price: '$500/month', description: 'Ongoing ads and marketing management' },
                { title: 'Premium Support Package', price: '$200/month', description: 'Priority support and monthly optimization' }
            ],
            portfolio: [
                { image: '', title: 'Medical Practice Platform', category: 'Healthcare', description: 'Custom patient portal with appointment booking and records' },
                { image: '', title: 'E-commerce Store', category: 'Retail', description: 'Full online store with inventory management and automation' },
                { image: '', title: 'Multi-Location Business', category: 'Franchise', description: 'Central brand with location-specific pages and management' }
            ]
        }
    ];
